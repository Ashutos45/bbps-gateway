...
import { User, Mail, Lock, Building, Loader2, ArrowLeft, ShieldAlert } from 'lucide-react';
...
export const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#030303] px-4 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-cyan-900/10 rounded-full blur-3xl pointer-events-none"></div>

      <div className="glass-card max-w-md w-full rounded-2xl p-8 relative z-10 border border-zinc-800/80 bg-zinc-950/40">
        {/* Navigation back to login */}
        <Link to="/login" className="flex items-center gap-1 text-[10px] text-zinc-550 hover:text-zinc-300 font-mono mb-6 uppercase tracking-wider transition-colors select-none">
          <ArrowLeft size={10} />
        ...
        <form onSubmit={handleSignup} className="space-y-4.5 font-mono text-xs">
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="mbanking_client_ref"
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="client@bob-mbanking.in"
                className="input-premium pl-10"
                disabled={loading}
                required
              />
          ...
          <button
            type="submit"
            className="w-full bg-cyan-600 hover:bg-cyan-500 text-black font-extrabold text-xs py-3 rounded-xl transition-all duration-200 shadow-lg shadow-cyan-950/20 flex items-center justify-center gap-2 cursor-pointer mt-4.5 disabled:bg-zinc-900 disabled:text-zinc-650"
            disabled={loading}
          >
            {loading ? (
              <>
              ...
              <span className="font-display uppercase tracking-wider font-black text-xs">Establish Client Account</span>
            )}
          </button>
        </form>
      </div>
