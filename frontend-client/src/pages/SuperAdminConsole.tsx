                ...
                <tbody className="divide-y divide-zinc-900/50">
                  {keysList.map((k) => (
                    <tr key={k.id} className="hover:bg-zinc-900/25">
                      ...
                      <td className="px-4 py-3 text-zinc-400 truncate max-w-xs">{k.user_id}</td>
                      ...
                      <td className="px-4 py-3 text-right whitespace-nowrap space-x-1.5">
                        <button
                          onClick={() => handleRegenerateKey(k.user_id)}
                        ...
                        <button
                          onClick={() => handleDeleteAdmin(k.user_id)}
